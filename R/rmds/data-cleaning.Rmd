...
Read in CCH2 data 
```{r}
sonoran_cch2 <- fread("/home/jt-miller/Gurlab/sliding-phenology/data/raw/cch2-sonoran_2023-11-27_150043_DwC-A/occurrences.csv")
```
Clean the CCH2 data
```{r}
# Find fields of interest. 
names(sonoran_cch2)
sonoran_cch2 <- sonoran_cch2[, .(id, informationWithheld, recordedBy, identifiedBy, eventDate, verbatimEventDate, decimalLatitude, decimalLongitude, coordinateUncertaintyInMeters, scientificName, taxonRank, reproductiveCondition)]

# Remove non-flowering annotations 
unique(sonoran_cch2$reproductiveCondition)
...
flowering_cch2 <- sonoran_cch2[!reproductiveCondition %in% non_repoductive_strings]
