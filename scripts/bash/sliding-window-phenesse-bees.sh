...
##example for running: sbatch /blue/soltis/millerjared/temp-sliding-phen/sliding-window-phenesse-bees.sh /blue/soltis/millerjared/temp-sliding-phen/outputs/phenesse-species-plots-par/ /blue/soltis/millerjared/temp-sliding-phen/outputs/phenesse-species-tables-par/